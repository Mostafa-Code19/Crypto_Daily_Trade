...
dataOfChart = 'Data/DataForIndicator_ETH_RSI.csv'
saveDataHere = 'Trade_Information/orderHistory_ETH_RSI.csv'
timePeriodForRSI = 14
RSILevelToBuy = 35
orderCounter = 1
...
def getDataForAnalyse():
    csvFile = open("Data/DataForIndicator_ETH_RSI.csv", 'w', newline='')
